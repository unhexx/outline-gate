...
Подробно: **[docs/DEPLOY.ru.md](docs/DEPLOY.ru.md)** · [English](docs/DEPLOY.md).
...
| Документ | Содержание |
|----------|------------|
| **[README.md](README.md)** | English README (default on GitHub) |
| **[docs/DEPLOY.ru.md](docs/DEPLOY.ru.md)** | Развёртывание на другом хосте (пошагово) |
| **[docs/OPERATIONS.ru.md](docs/OPERATIONS.ru.md)** | Полный справочник развёртывания и эксплуатации |
